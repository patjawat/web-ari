...
const Communication = props =>
  <div className="auth">
    ...
    <div className="request-access">
      <p><span className="you-left">You hung up.&nbsp;</span>ระบุชื่อเพื่อเข้าสู่ห้องสนทนา.</p>
      <form onSubmit={props.send}>
        <input type="text" autoFocus onChange={props.handleInput} value={props.message} data-ref="message"  maxLength="30" required placeholder="Hi, I'm John Doe." />
